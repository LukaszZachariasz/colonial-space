...
export class FromAboveCamera extends BABYLON.ArcRotateCamera {
    ...
    public maxRight = MapGenerator.MapHeight * (Hex.HexWidth + Hex.HexEdgeWidth) - Hex.HexWidth;
    public maxTop = -Hex.HexHeight;
    public maxBottom = -MapGenerator.MapHeight * Hex.HexHeight;
