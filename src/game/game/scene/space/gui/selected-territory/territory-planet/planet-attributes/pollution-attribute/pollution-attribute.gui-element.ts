...
@GuiElement()
export class PollutionAttributeGuiElement implements GuiControl<GUI.Container>, AfterCreated, OnReady, OnDestroy {
    ...
    private generateTooltipContent(): string {
        ...
        return `Pollution ${this.planetState.data.pollution}%
            ...
            It's provide ${Container.get(PlanetProductionService).getPollutionProduction(this.planetState.data.pollution)} production.`;
    }
