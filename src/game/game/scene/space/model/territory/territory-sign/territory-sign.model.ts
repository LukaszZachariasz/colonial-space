...
export class TerritorySignModel extends SimpleModel<BABYLON.Mesh> {
    ...
    private createTerritorySignTitleContainer(): void {
        ...
        Container.get(GuiManagerService).createForMesh('TerritorySignTitleContainer', this.mesh, this.territorySignTitleContainer, this.GUI_SIZE * this.WIDTH, this.GUI_SIZE * this.HEIGHT);
    }
}
