...
import {UnitGenerator} from '../../../../store-generator/unit-generator/unit-generator';
...
@HasTourEffects()
export class ScoutShipHandlerService {
    ...
    private afterBuildingProcess(): Observable<any> {
        return new Observable<any>((subscriber: Subscriber<any>) => {
            ...
            buildingObjects.forEach((object: BuildingObjectState) => {
                ...
                const unit = this.unitGenerator.generate(selectPlayerId());
