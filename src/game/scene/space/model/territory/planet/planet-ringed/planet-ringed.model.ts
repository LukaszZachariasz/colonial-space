...
export class PlanetRingedModel extends TerritoryModel {
    ...
    constructor(public scene: BABYLON.Scene,
        ...
        BABYLON.SceneLoader.ImportMesh('', 'resources/territory/planet/planet-ringed/', 'planet_01.glb', scene, (meshes: BABYLON.AbstractMesh[]) => {
