...
export class PlanetMetalModel extends TerritoryModel {
    ...
    constructor(public scene: BABYLON.Scene,
        ...
        BABYLON.SceneLoader.ImportMesh('', 'resources/territory/planet/planet-metal/', 'planet_01.glb', scene, (meshes: BABYLON.AbstractMesh[]) => {
