...
export class SunlightAttributeGuiElement implements GuiControl<GUI.Container>, AfterCreated, OnReady, OnDestroy {
    ...
    @AppendGuiControl() public attributeControl: AttributeGuiElement = new AttributeGuiElement(new IconGuiElement(GameIcon.SUN), new TextGuiElement(this.generateTooltipContent()));
