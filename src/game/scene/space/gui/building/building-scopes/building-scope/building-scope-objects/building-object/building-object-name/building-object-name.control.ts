...
export class BuildingObjectNameControl extends Control {
    private textControl: TextControl = new TextControl(this.buildingObjectState.name.toString());
    ...
    public render(): GUI.Control {
        ...
        this.textControl.textBlock.horizontalAlignment = GUI.Control.HORIZONTAL_ALIGNMENT_LEFT;
